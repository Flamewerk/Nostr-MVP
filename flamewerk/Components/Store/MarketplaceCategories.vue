  ...
  <div class="">
    ...
    <main class="pb-24">
      <div class="py-16 px-4 text-center sm:px-6 lg:px-8">
        <h1 class="text-4xl font-bold tracking-tight text-gray-900">Marketplace</h1>
        <p class="mx-auto mt-4 max-w-xl text-base text-gray-500">Only pulls vetterd products from the Shop N' Go Relay Tracing trough all update messages linked to the product id</p>
      </div>
