  ...
  <Popover class="flex mx-auto mt-2" v-slot="{ open }">
    <PopoverButton
      :class="[
        ...
        'group inline-flex items-center rounded-md bg-colorSwitchBgLight dark:bg-colorSwitchBgDark text-base font-medium hover:text-gray-900 focus:outline-none ',
      ]"
    >
      <img
